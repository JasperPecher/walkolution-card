...
const DEFAULT_CONFIG = {
  ...
  session_distance_font_size: '24px',
  ...
  _updateContent() {
    ...
    if (config.session_distance_entity) {
      rows.push({
        ...
        val: sessionVal,
        unit: config.session_distance_unit ? ` ${config.session_distance_unit}` : '',
    ...
    if (config.total_distance_entity) {
      rows.push({
        ...
        val: totalVal,
        unit: config.total_distance_unit ? ` ${config.total_distance_unit}` : '',
